...
def main(learning_rate=5e-4,
    ...
    train_dataset = Aduio_DataLoader(
        r'C:\Users\Allen\Desktop\ntut-dl-2020-spring-taiwanese-E2E\train\train')
    val_dataset = Aduio_DataLoader(
        r'C:\Users\Allen\Desktop\ntut-dl-2020-spring-taiwanese-E2E\train\val')
    ...
    plt.legend(loc='best')
    plt.savefig(r'C:\Users\Allen\Desktop\Speech_Recognition-PyTorch-main\image\wer.jpg')
    plt.show()
